...
Usage:
python2 main.py --corpus <gzipped corpus path> --embeddings <gzipped embeddings path> --train <train questions path> --dev <dev questions path> --test <test questions path> --model <lstm | cnn> --results_file <csv path> --batch_size <int batch size> --hidden_size <100> --embedding_size <200 | 300> --cuda <0 | 1>--save_model <0 | 1> --margin <float margin>

Example Usage: 
(LSTM)
python2 main.py --corpus ../askubuntu/text_tokenized.txt.gz --embeddings ../askubuntu/vector/vectors_pruned.200.txt.gz --train ../askubuntu/train_random.txt  --dev ../askubuntu/dev.txt --test ../askubuntu/test.txt --model lstm --results_file lstm_results.csv --batch_size 25 --hidden_size 100 --embedding_size 200 --cuda 1 --save_model 1 --margin 0.3

(CNN)
python2 main.py --corpus ../askubuntu/text_tokenized.txt.gz --train ../askubuntu/train_random.txt --embeddings ../askubuntu/vector/vectors_pruned.200.txt.gz --dev ../askubuntu/dev.txt --test ../askubuntu/test.txt --model cnn --results_file cnn_results.csv --batch_size 25 --hidden_size 100 --embedding_size 200 --cuda 1 --save_model 1 --margin 0.3
"""
